class Admin::GalleriesController < Admin::AdminController
  ...
  def publish
    ...
    redirect_to admin_gallery_path(@gallery), :notice => "Gallery:".html_safe+"#{@gallery.name}"+", is now published. #{view_context.link_to 'Undo', archive_admin_gallery_path(@gallery)}".html_safe
  end
  ...
  def archive
    ...
    redirect_to admin_gallery_path(@gallery), :notice => "Gallery:".html_safe+"#{@gallery.name}"+", is now archived. #{view_context.link_to 'Undo', publish_admin_gallery_path(@gallery)}".html_safe
  end
