...
class MobileAppVersion < ActiveRecord::Base
  ...
  validates_presence_of :name, message: 'Store URL can’t be blank' 
  #validates :platform, presence: true
  validates_presence_of :name, message: 'Platform can’t be blank' 
  #validates :device, presence: true
  validates_presence_of :name, message: 'Product Type can’t be blank' 
end
